...
export class Sh1694175304973 implements MigrationInterface {
  name = 'Sh1694175304973';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "deals" ADD "more_than_one_year" boolean NOT NULL DEFAULT false`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "deals" DROP COLUMN "more_than_one_year"`
    );
    await queryRunner.query(
